    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 pb-20">
      ...
      >
        ...
        <div className="flex items-center gap-1">
          <span className="font-[family-name:var(--font-orbitron)] text-[0.45rem] tracking-[0.15em] text-orbital-text-dim mr-2">STATUS</span>
          {([
        ...
        {/* Format filter */}
        <div className="flex items-center gap-1">
          <span className="font-[family-name:var(--font-orbitron)] text-[0.45rem] tracking-[0.15em] text-orbital-text-dim mr-2">FORMATO</span>
          {([
            { value: "all", label: "Todos" },
        ...
        <div className="relative overflow-hidden border border-orbital-border hover:border-orbital-purple/30 transition-all duration-300">
          ...
          {t.status === "active" && (
            <div className="absolute top-3 right-3 flex items-center gap-1.5 px-2 py-1 bg-red-500/20 border border-red-500/40">
              ...
              <span className="font-[family-name:var(--font-orbitron)] text-[0.45rem] tracking-[0.2em] text-red-500">LIVE</span>
            </div>
          )}
              ...
              <div className="flex items-center gap-2">
                {t.status === "finished" && (
                  <span className="flex items-center gap-1.5 px-2 py-0.5 bg-emerald-500/10 border border-emerald-500/30">
                    ...
                    <span className="font-[family-name:var(--font-orbitron)] text-[0.45rem] tracking-[0.15em] text-emerald-500">FINALIZADO</span>
                  </span>
                )}
                {t.status === "pending" && (
                  <span className="px-2 py-0.5 bg-yellow-500/10 border border-yellow-500/30">
                    <span className="font-[family-name:var(--font-orbitron)] text-[0.45rem] tracking-[0.15em] text-yellow-500">EM BREVE</span>
                  </span>
                )}
              </div>
            ...
            <div className="flex items-start justify-between gap-4 mb-5">
              ...
              {winnerTeam && (
                <div className="flex items-center gap-3 shrink-0 px-4 py-3 bg-amber-500/5 border border-amber-500/30">
                  ...
                  <div>
                    <div className="font-[family-name:var(--font-orbitron)] text-[0.4rem] tracking-[0.2em] text-amber-500/70">CAMPEÃO</div>
