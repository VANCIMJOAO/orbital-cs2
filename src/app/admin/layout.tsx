...
import { Shield, Swords, Users, Server, Calendar, ArrowLeft, Trophy, Home, ChevronRight, Gamepad2, Megaphone, Bot } from "lucide-react";
...
const brandSubLinks = [
  { href: "/admin/brand", label: "Brand Intelligence", icon: Bot, exact: true },
];
